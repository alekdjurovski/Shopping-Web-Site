...
export class AddEditCategoryComponent implements OnInit {
    ...
    addCategory() {
      ...
      this._serviceCategory.addCategories(this.newForm).subscribe((res: IProduct) => {
    ...
    fillForm() {
      this._serviceCategory.getOneCategory(this.categoryId).subscribe(res => {
        this.editForm = res;
        this.form.get('name').setValue(this.editForm.name);
        this.form.get('parentCategoryName').setValue(this.editForm.parentCategoryName);
        this.form.get('description').setValue(this.editForm.description);
      });
    }

    updateCategory() {
      this._serviceCategory.updateCategories(this.categoryId, this.form.value)
